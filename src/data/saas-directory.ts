...
export const saasTools: SaasTool[] = [
  {
    ...
    reviewVoice: "처음엔 이것저것 다 시키기보다 블로그 초안이나 고객 답변 하나만 맡겨보면 감이 빨리 와요. 다만 사실 확인은 꼭 따로 봐야 합니다.",
  ...
  },
  {
    ...
    reviewVoice: "긴 글 붙여놓고 요약하거나 말투 정리할 때 편합니다. 기획서나 회의록이 많은 사람은 체감이 크고, 이미지 작업용으로 보면 아쉬워요.",
  ...
  },
  {
    ...
    reviewVoice: "검색을 완전히 대신한다기보다 출처 링크를 모아주는 도구라고 보면 편합니다. 자료 조사할 때 탭을 덜 열어도 되는 느낌이에요.",
  ...
  },
  {
    ...
    reviewVoice: "디자인을 잘 몰라도 템플릿 골라서 문구만 바꾸면 결과물이 빨리 나옵니다. 대신 많이 쓰는 템플릿 느낌은 조금 날 수 있어요.",
  ...
  },
  {
    ...
    reviewVoice: "쇼츠 자막 붙이고 컷 정리하는 데는 부담이 적습니다. 브랜드 영상처럼 디테일이 중요한 작업은 사람이 한 번 더 봐야 해요.",
  ...
  },
  {
    ...
    reviewVoice: "긴 영상이 이미 있다면 꽤 편합니다. AI가 뽑은 클립을 그대로 올리기보다는 후킹 좋은 것만 골라 쓰는 느낌이에요.",
  ...
  },
  {
    ...
    reviewVoice: "폼 하나 급하게 열어야 할 때 편합니다. 대기자 모집이나 제보 받기는 좋고, 복잡한 예약/결제까지 기대하면 부족해요.",

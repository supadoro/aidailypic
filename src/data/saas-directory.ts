...
export const saasTools: SaasTool[] = [
  {
    ...
    reviewVoice: "ChatGPT는 쉽게 말하면 글, 아이디어, 질문 답변을 대신 초안으로 만들어주는 AI 대화 도구입니다. 처음 쓰는 분이라면 블로그 글 하나를 통째로 맡기기보다, 상품 설명 초안이나 고객 답변처럼 작은 작업부터 넣어보는 게 이해가 빠릅니다. 결과가 바로 나와서 편하지만, 숫자나 최신 정보는 틀릴 수 있으니 그대로 올리기 전에 한 번 더 확인하는 쪽이 좋습니다.",
  ...
  },
  {
    ...
    reviewVoice: "Claude는 긴 문서를 읽고 정리하는 데 강한 AI 도구라고 보면 쉽습니다. 회의록, 기획안, 고객 응대 문서처럼 분량이 긴 자료를 넣었을 때 핵심을 뽑고 말투를 차분하게 다듬는 쪽에서 장점이 잘 보입니다. 이미지 편집이나 디자인을 기대하고 들어가면 맞지 않고, 글과 문서 정리가 많은 사람에게 더 잘 맞습니다.",
  ...
  },
  {
    ...
    reviewVoice: "Perplexity는 검색 결과를 그냥 나열하기보다, 질문에 대한 답과 참고한 출처를 같이 보여주는 리서치 도구입니다. 처음 보는 사람은 ‘AI가 답을 맞혀준다’보다 ‘자료 찾는 시간을 줄여준다’고 이해하면 좋습니다. 답변 문장만 복사하기보다는 옆에 붙은 출처 링크를 열어보는 식으로 쓰면 훨씬 안전합니다.",
  ...
  },
  {
    ...
    reviewVoice: "Canva는 디자이너가 아니어도 카드뉴스, 썸네일, 배너 같은 이미지를 빠르게 만들 수 있게 해주는 디자인 툴입니다. 템플릿을 고르고 문구와 색만 바꿔도 결과물이 나와서 처음 시작하기 쉽습니다. 다만 많은 사람이 쓰는 템플릿은 비슷해 보일 수 있고, 상업적으로 쓸 이미지는 라이선스 확인을 한 번 해두는 게 좋습니다.",
  ...
  },
  {
    ...
    reviewVoice: "CapCut은 쇼츠, 릴스, 틱톡 같은 짧은 영상을 편집하기 쉽게 만든 영상 편집 도구입니다. 자막을 붙이고 화면 비율을 맞추고 템플릿 효과를 넣는 작업이 쉬워서, 영상 편집을 처음 하는 사람도 부담이 적습니다. 대신 브랜드 영상처럼 톤과 컷이 중요한 작업은 자동 기능만 믿기보다 사람이 마지막으로 다듬어야 합니다.",
  ...
  },
  {
    ...
    reviewVoice: "OpusClip은 긴 영상을 짧은 숏폼 후보로 잘라주는 AI 클리핑 도구입니다. 이미 유튜브 영상, 강의, 인터뷰 영상이 있는 사람에게 특히 이해가 쉽습니다. AI가 알아서 여러 클립을 뽑아주지만, 그대로 올리는 도구라기보다는 그중 괜찮은 장면을 골라 자막과 시작 부분을 다시 손보는 용도로 보는 게 현실적입니다.",
  ...
  },
  {
    ...
    reviewVoice: "Tally는 설문지나 신청 폼을 문서 쓰듯이 만드는 폼 빌더입니다. 대기자 모집, 베타 신청, 툴 제보, 간단한 고객 설문처럼 ‘일단 입력받을 곳’이 필요할 때 빠르게 만들기 좋습니다. 복잡한 예약, 결제, CRM까지 한 번에 처리하는 운영 시스템을 기대하면 부족하고, 가볍게 수집을 시작하는 용도로 보면 잘 맞습니다.",
